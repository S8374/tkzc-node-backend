...
const credentialsLogin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!identifier || !password) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "Username/email and password are required");
    }
...
const getMe = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Get user's wallet
    const wallet = yield wallet_model_1.Wallet.findOne({ user: userId }).select("-__v");
    // Combine user and wallet data
    const userObject = user.toObject();
    return Object.assign(Object.assign({}, userObject), { wallet: wallet ? {
...
exports.AuthServices = { credentialsLogin, getMe };
